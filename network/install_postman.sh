...
_echo_info "sudo chmod +x \"$(xdg-user-dir DESKTOP)/${DESKTOP}\"\n"
sudo chmod +x "$(xdg-user-dir DESKTOP)/${DESKTOP}"

# allow launching
_echo_info "gio set \"$(xdg-user-dir DESKTOP)/${DESKTOP}\" metadata::trusted true\n"
gio set "$(xdg-user-dir DESKTOP)/${DESKTOP}" metadata::trusted true
