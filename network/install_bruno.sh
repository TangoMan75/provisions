...
echo_warning 'Creating APT keyrings directory\n'
...
echo_warning 'Adding Bruno repository GPG key\n'

echo_info "curl -fsSL \"https://keyserver.ubuntu.com/pks/lookup?op=get&search=0x9FA6017ECABE0266\" | gpg --dearmor | sudo tee /etc/apt/keyrings/bruno.gpg > /dev/null\n"
...
echo_warning 'Setting GPG key permissions\n'

echo_info "sudo chmod 644 /etc/apt/keyrings/bruno.gpg\n"
sudo chmod 644 /etc/apt/keyrings/bruno.gpg

#--------------------------------------------------

echo_warning 'Adding Bruno repository\n'

echo_info "echo \"deb [arch=amd64 signed-by=/etc/apt/keyrings/bruno.gpg] http://debian.usebruno.com/ bruno stable\" | sudo tee /etc/apt/sources.list.d/bruno.list\n"
...
echo_info "sudo apt-get install -y ${APP_NAME}\n"
