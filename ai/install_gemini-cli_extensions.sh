...
if [ ! -x "$(command -v gemini)" ]; then
    echo_danger "error: \"$(basename "${0}")\" requires gemini\n"
    exit 1
fi

#--------------------------------------------------

alert_primary 'Install Google Workspace gemini-cli extension'

#--------------------------------------------------

echo_info 'gemini extensions install "https://github.com/gemini-cli-extensions/workspace --auto-update"\n'
gemini extensions install "https://github.com/gemini-cli-extensions/workspace --auto-update"

#--------------------------------------------------

echo_info 'gemini extensions install https://github.com/AsyncFuncAI/ralph-wiggum-extension --auto-update\n'
