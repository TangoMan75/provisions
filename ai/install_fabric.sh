...
echo_warning 'Move fabric binary to /usr/bin\n'
echo_info 'This will make fabric availlable globally, including scripts\n'

echo_info "sudo mv \"${HOME}/.local/bin/fabric\" \"/usr/bin\"\n"
