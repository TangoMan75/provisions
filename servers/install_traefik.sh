...
alert_primary "Install traefik v${VERSION}"
exit 0
...
echo_info "wget -qO traefik.tar.gz \"https://github.com/${REPOSITORY}/releases/download/v${VERSION}/${FILENAME}\""
...
echo_info 'sudo mv -fv traefik /usr/local/bin/traefik'
