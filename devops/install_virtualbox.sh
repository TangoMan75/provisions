...
alert_info 'Install VirtualBox Dependencies'
...
echo_info "sudo apt-get install --reinstall linux-headers-\"$(uname -r)\"\n"
...
echo_warning 'Fix missing dependencies\n'

echo_info 'sudo apt-get --fix-broken --assume-yes install\n'
...
alert_info 'Setup VirtualBox'

#--------------------------------------------------

echo_warning 'Setup VirtualBox Linux kernel driver\n'
...
echo_warning 'Load VirtualBox driver\n'
