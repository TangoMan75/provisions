...
while getopts :v:h OPTION; do
    case "${OPTION}" in
        v) VERSION="${OPTARG}";;
        h) echo_success 'description:' 2 14; echo_primary 'Install virtualbox\n'
...
echo_info 'sudo systemctl mask virtualbox.service\n'
...
echo_info 'sudo systemctl unmask virtualbox.service\n'
sudo systemctl unmask virtualbox.service

#--------------------------------------------------

echo_warning 'Install extension pack\n'
