...
# remove desktop link
echo_info 'rm ~/Desktop/phpstorm_phpstorm.desktop'
rm ~/Desktop/phpstorm_phpstorm.desktop
...
# echo_info "rm -f ~/.config/JetBrains/PhpStorm${VERSION}/eval/*"
# rm -f ~/.config/JetBrains/PhpStorm${VERSION}/eval/*

# remove phpstorm config
echo_info "rm -rf ~/.config/JetBrains/PhpStorm${VERSION}"
