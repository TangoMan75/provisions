...
echo_info 'code --install-extension TangoMan75.command-cycle\n\n'
...
echo_info 'code --install-extension sst-dev.opencode\n\n'
code --install-extension sst-dev.opencode

# # https://marketplace.visualstudio.com/items?itemName=Google.geminicodeassist
# echo_info 'code --install-extension Google.geminicodeassist\n\n'
# code --install-extension Google.geminicodeassist

# https://marketplace.visualstudio.com/items?itemName=Google.gemini-cli-vscode-ide-companion
echo_info 'code --install-extension Google.gemini-cli-vscode-ide-companion\n\n'
...
# echo_info 'code --install-extension zhyong10.markdown-html\n\n'
...
echo_info 'code --install-extension TheNouillet.symfony-vscode\n'
...
echo_info 'code --install-extension mblode.twig-language-2\n'
...
# echo_info 'code --install-extension Vue.volar\n\n'
