...
# Get folder name eg: PhpStorm-233.15619.9
...
# Get install directory eg: ~/.local/share/JetBrains/Toolbox/apps/PhpStorm/ch-0/233.15619.9/
...
# sudo ln -s ~/.local/share/JetBrains/Toolbox/apps/PhpStorm/ch-0/*/bin/phpstorm.sh /usr/bin/phpstorm
