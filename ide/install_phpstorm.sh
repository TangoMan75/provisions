...
DEFAULT_VERSION=2023.3.2
VALID_VERSIONS=(2016.1.2 2016.2.2 2016.3.4 2017.1.5 2017.2.5 2017.3.7 2018.1.7 2018.2.7 2018.3.6 2019.1.4 2019.2.5 2019.3.4 2020.1.4 2020.2.4 2020.3.3 2021.1.4 2021.2.4 2021.3.3 2022.1.4 2022.2.5 2022.3.3 2023.1.4 2023.2.4 2023.3.2)
...
while getopts :v:h OPTION; do
    case "${OPTION}" in
        v) VERSION="${OPTARG}";;
        h) echo_label 12 'description'; echo_primary 'Install PHPStorm'
...
alert_primary "Install PHPStorm v${VERSION}"
