...
# config pycharm
echo_info "cp -Rfv \"${CONFIG_DIR}/home/.config/JetBrains/PyCharmCE/\" ~/.config/JetBrains/PyCharmCE${VERSION}"
cp -Rfv "${CONFIG_DIR}/home/.config/JetBrains/PyCharmCE/" ~/.config/JetBrains/PyCharmCE${VERSION}
