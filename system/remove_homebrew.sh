...
if [ -x "$(command -v curl)" ]; then
    echo_info "/bin/bash -c \"$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/uninstall.sh)\"\n"
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/uninstall.sh)"

elif [ -x "$(command -v wget)" ]; then
    echo_info "/bin/bash -c \"$(wget -qO- https://raw.githubusercontent.com/Homebrew/install/HEAD/uninstall.sh)\"\n"
...
echo_warning 'Configure shell environment\n'
