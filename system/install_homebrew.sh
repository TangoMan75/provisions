...
if [ -x "$(command -v curl)" ]; then
    ...
    echo_info "/bin/bash -c \"$(wget -qO- https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)\"\n"
...
echo_warning 'Verify installation\n'

echo_info 'brew doctor\n'
brew doctor

echo_info 'brew --version\n'
brew --version
