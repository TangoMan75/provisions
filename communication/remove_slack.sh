...
## @link     https://slack.com/downloads/instructions/linux?ddl=1&build=deb
...
_echo_info "rm \"$(xdg-user-dir DESKTOP)\"/\"${DESKTOP}\".desktop\n"
rm "$(xdg-user-dir DESKTOP)"/"${DESKTOP}".desktop
