---
name: create_install_script
description: Scaffold a new install_*.sh (and matching remove_*.sh) for TangoMan Provisions from a free-form prompt (app name, URL, npm package, or mixed).
---
...
Read `the user's request`. Strip leading/trailing whitespace. If empty, ask the user to provide a name or URL.
