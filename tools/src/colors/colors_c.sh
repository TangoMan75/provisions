...
echo_primary()   { printf '%b%b\033[0m\n' '\033[97m'    "${*}"; }
echo_secondary() { printf '%b%b\033[0m\n' '\033[94m'    "${*}"; }
echo_success()   { printf '%b%b\033[0m\n' '\033[32m'    "${*}"; }
echo_danger()    { printf '%b%b\033[0m\n' '\033[31m'    "${*}"; }
echo_warning()   { printf '%b%b\033[0m\n' '\033[33m'    "${*}"; }
echo_info()      { printf '%b%b\033[0m\n' '\033[95m'    "${*}"; }
echo_light()     { printf '%b%b\033[0m\n' '\033[47;90m' "${*}"; }
echo_dark()      { printf '%b%b\033[0m\n' '\033[40;37m' "${*}"; }
