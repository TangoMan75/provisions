...
alert_primary "Install MyCrypto v${VERSION}"
...
echo_info 'mkdir -p ~/.mycrypto\n'
mkdir -p ~/.mycrypto

# -O,  --output-document=FILE      write documents to FILE
echo_info "wget -qO ~/.mycrypto/mycrypto.AppImage https://github.com/MycryptoHQ/MyCrypto/releases/download/${VERSION}/linux-x86-64_${VERSION}_MyCrypto.AppImage\n"
...
echo_info 'chmod a+x ~/.mycrypto/mycrypto.AppImage\n'
chmod a+x ~/.mycrypto/mycrypto.AppImage

echo_info 'cp -fv mycrypto.png ~/.mycrypto\n'
