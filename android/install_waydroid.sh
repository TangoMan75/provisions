...
alert_primary 'Install waydroid'

echo_info 'sudo apt install curl ca-certificates -y\n'
sudo apt install curl ca-certificates -y

echo_info 'curl https://repo.waydro.id | sudo bash\n'
curl https://repo.waydro.id | sudo bash

echo_info 'sudo apt-get install --assume-yes waydroid\n'
