...
REMOTE_FILE="${APP_NAME}_${VERSION}_Linux_x86_64.tar.gz"
ARCHIVE="${REMOTE_FILE}"
...
echo_warning "Downloading ${APP_NAME} from ${URL}\n"
...
echo_info "tar -xzf \"${TEMP_DIR}/${ARCHIVE}\" -C \"${TEMP_DIR}\"\n"
